// long-parameter-list: seven parameters instead of a data class.
fun createUser(firstName: String, lastName: String, email: String, phone: String, street: String, city: String, zip: String): String {
