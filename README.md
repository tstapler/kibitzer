...
kibitzer lsp                         # serve as an LSP server over stdio (diagnostics) (see docs/lsp.md)
...
kibitzer check duplicates <dir>      # cross-file duplicate-code detection, repo-wide (Go v1)
